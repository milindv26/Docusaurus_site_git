...
**Question:** Prove if $u$ and $x$ are mean independent, then $\mathbb{E}[u∣x]=\mathbb{E}[u]$. [[Sol]](https://macropy.com/Notebooks_Courses/docs/math_stat/Statistics/imp_stats_result#mean-independence-and-covariance)
