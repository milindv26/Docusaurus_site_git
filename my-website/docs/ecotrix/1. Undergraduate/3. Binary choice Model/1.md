...
$$
\begin{align*}
&\frac{\partial(P[y_i=1|\bold{x}_i])}{\partial x_j}=\frac{e^{\beta_0+\beta_1 x_1+...+\beta_j x_j+...}}{(1+e^{\beta_0+\beta_1 x_1+...+\beta_j x_j+...})^2}\cdot \beta_j = (F(\bold{x'}_i\boldsymbol{\beta})).(1-F(\bold{x'}_i\boldsymbol{\beta}))\cdot \beta_j
\end{align*}
$$
>**Aside**
>
