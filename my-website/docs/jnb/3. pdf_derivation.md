...
>$$
>Switch from Cartesian coordinates $(x,y)$ to polar coordinates $(r,\theta)$. In polar coordinates, $x^2+y^2=r^2$ >and $dx dy=r dr d\theta$.[[How?]](https://macropy.com/Notebooks_Courses/docs/math_stat/Mathematics/cartesian_to_polar) 
>
