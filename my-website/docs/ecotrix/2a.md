...
$$
\begin{align*}
    \mathbb{E}\Bigg[\frac{1}{n}\sum_{i=1}^n e_i^2\Bigg]&=\frac{1}{n}\mathbb{E}[\bold{e'e}],\\
    \implies \mathbb{E}\Bigg[\frac{1}{n}\sum_{i=1}^n e_i^2|\bold{X}\Bigg]&=\frac{1}{n}\mathbb{E}[\bold{e'e}|\bold{X}]=\frac{1}{n}\sigma^2(n-K),\\
\end{align*}
$$
we have found that 