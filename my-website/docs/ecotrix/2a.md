...
\end{align*}
$$
We know that $\mathbb{E}[\text{Tr}(\bold{X})]=\text{Tr}(\mathbb{E}[\bold{X}])$ How, therefore,
$$
\begin{align*}
...
\begin{align*}
    ...
    &=\text{Tr}(\bold{M}\sigma^2\bold{I}),\\
    &=\sigma^2\text{Tr}(\bold{M}),\\
    &=\sigma^2\text{Tr}(\bold{I-X(X'X)^{-1}X'}),\\
    &=\sigma^2\Big\{\text{Tr}(\bold{I})-\text{Tr}\bold{(X(X'X)^{-1}X')}\Big\}.\\
\end{align*}
$$